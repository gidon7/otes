...
info.put("action_type_conv", m.getItem(info.s("action_type"), actionLog.types));
info.put("module_conv", m.getItem(info.s("module"), actionLog.modules));
