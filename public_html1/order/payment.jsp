...
boolean isFree = Math.max(payPrice, 0) == 0;
...
//2022-04-04 회원명의 길이가 너무 길어서 올앳 결제 진행 안되는 문제로 20Byte로 커트
pinfo.put("buyer", "allat".equals(siteinfo.s("pg_nm")) ? m.cutString(userName, 20, "") : userName);
...
priceInfo.put("pay_price_conv", m.nf(Math.max(payPrice, 0)));
