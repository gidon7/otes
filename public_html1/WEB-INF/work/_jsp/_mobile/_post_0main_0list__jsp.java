...
public class _post_0main_0list__jsp extends com.caucho.jsp.JavaPage
{
...
DataSet list = post.query(
	"SELECT a.*, b.board_nm, b.code, f.filename, c.category_nm "
	+ " FROM " + post.table + " a "
	...
	+ " ORDER BY " + (useNotice ? "a.notice_yn desc, " : "") + ord
	, count
);
while(list.next()) {
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("mobile/post_main_list.jsp"), -6561924877288323690L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
