...
while(list.next()) {
    list.put("content", m.cutString(list.s("content"), 50));
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/post/index.jsp"), 5867007043423330419L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
