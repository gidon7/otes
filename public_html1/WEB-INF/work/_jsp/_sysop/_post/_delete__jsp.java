...
//\uc0ad\uc81c
if(!"".equals(m.rs("id"))) {
    DataSet info = post.find("id = '" + m.rs("id") + "'");
    if(!info.next()) { m.jsError("\ud574\ub2f9 \uc815\ubcf4\uac00 \uc5c6\uc2b5\ub2c8\ub2e4."); return; }

    post.item("status", -1);
    if(!post.update("id = '" + m.rs("id") + "'")) {
...
m.jsReplace("index.jsp?" + m.qs("id, idx"));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/post/delete.jsp"), 3159031664611442551L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
