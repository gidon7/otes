...
lm.setListMode(0);
lm.setListNum("excel".equals(m.rs("mode")) ? 65000 : f.getInt("s_listnum", 20));
lm.setTable(
	userLogin.table + " a "
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/user/login_list.jsp"), -258497103296832086L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
