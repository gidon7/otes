...
f.addElement("display_yn", info.s("display_yn"), "hname:'\ub178\ucd9c', required:'Y'");
...
if(m.isPost() && f.validate()) {
	...
	book.item("status", f.getInt("status"));
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/book/book_modify.jsp"), -3601571665581524412L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
