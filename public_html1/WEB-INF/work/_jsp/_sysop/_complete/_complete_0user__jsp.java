...
if("complete_y".equals(m.rs("mode"))) {
	...
	while(culist.next()) {
		...
		if(!courseUser.update("id = " + culist.s("id") + "")) { }
	}
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/complete/complete_user.jsp"), -5875751897903466379L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
