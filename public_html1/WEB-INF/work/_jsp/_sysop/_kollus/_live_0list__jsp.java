...
if("".equals(SiteConfig.s("kollus_live_access_token"))) {
    ...
    //\ucc98\ub9ac-\uc2b9\uc778
    if("".equals(code) || "".equals(state)) { m.redirect(oauth.getAuthUrl("kollus_live")); return; }
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/kollus/live_list.jsp"), 5110870594844111364L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/kollus/init_live.jsp"), -2019533343157714504L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
