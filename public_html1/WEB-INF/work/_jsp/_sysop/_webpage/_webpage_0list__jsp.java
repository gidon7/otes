...
while(list.next()) {
	list.put("webpage_nm_conv", m.cutString(list.s("webpage_nm"), 30));
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/webpage/webpage_list.jsp"), 5682985378943279123L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
