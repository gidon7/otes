...
public class _logintest__jsp extends com.caucho.jsp.JavaPage
{
...
if(userId != 0 && !"SYSLOGIN".equals(userSessionId) && !siteinfo.b("duplication_yn") && !UserSession.isValid(userSessionId, userId)) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("testing/main/logintest.jsp"), -9057090624886819382L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
