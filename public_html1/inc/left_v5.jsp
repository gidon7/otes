...
if("mypage".equals(pcode) && isRemoteHost) {
	_rs.last();
	_rs.addRow();
	_rs.put("site_id", siteId);
	_rs.put("code", "mycourselesson");
	_rs.put("parent_cd", "mypage");
	_rs.put("depth", 2);
	_rs.put("link", "/mypage/course_lesson_list.jsp");
	_rs.put("menu_nm", "내화상강의");
	_rs.put("target", "_self");
	_rs.put("sort", 99);
	_rs.put("display_yn", "Y");
	_rs.first();
}
