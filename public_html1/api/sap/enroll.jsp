...
if(cinfo != null && courseUser.findCount("course_id = ? AND user_id = ? AND start_date = ? AND end_date = ? AND complete_yn != 'Y' AND status = 1", new Object[] { cinfo.s("id"), uid, startDate, endDate}) > 0) {
