...
public class _p1__jsp extends com.caucho.jsp.JavaPage
{
...
if(m.isPost() && "q1".equals(f.get("mode"))) {
    int num1 = f.getInt("num1");
    a1 = algo.numberSum(num1);
}


p.setLayout(ch);
p.setBody("Algorithm.p1");
p.setVar("a1", a1);
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/p1.jsp"), -1180670100954522629L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
