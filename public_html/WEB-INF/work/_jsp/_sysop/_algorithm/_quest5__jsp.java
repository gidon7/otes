...
public class _quest5__jsp extends com.caucho.jsp.JavaPage
{
...
if(m.isPost() && "q1".equals(f.get("mode"))) {
    ...
    a1 = algo.allahna(str1, str2);

}
p.setLayout(ch);
p.setBody("Algorithm.quest5");
p.setVar("a1", a1);
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/quest5.jsp"), 3802803151301223867L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
