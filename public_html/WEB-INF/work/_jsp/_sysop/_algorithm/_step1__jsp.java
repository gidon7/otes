...
if(m.isPost() && "q1".equals(f.get("mode"))) {
    //1
    String str = f.get("textString");
    String ori = f.get("char");
    char t = ori.charAt(0);
    a1 = algo.findChar(str, t);

} else if(m.isPost() && "q2".equals(f.get("mode"))) {
    //2
    String q2var = f.get("q2");
    a2 = algo.upperLower(q2var);

} else if(m.isPost() && "q3".equals(f.get("mode"))) {
    //3
    String q3var = f.get("q3");
    a3 = algo.longestWord(q3var);

}
//else if(m.isPost() && "q4".equals(f.get("mode"))) {
//    //4
////    String q4var = f.get("q4");
//    String ne = f.get("ns");
//    b1 = algo.pibo(Integer.parseInt(ne));
//
//
//}
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/step1.jsp"), 6981094691962811127L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
